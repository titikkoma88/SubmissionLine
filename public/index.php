...
$channel_access_token = "l8PoQYZe729+DqRu698ngH/ux4Jmz+UIlkrsXpq/RRYXhkXMUXd32YkE1uN4W2l32zPXc3FEF4g+NwU9oP5oT+tuT8f/auNz2OINsGdfY8ryx50DQDCwtRl466uUoWiY4VxSTHBUxj0feZO+eRzWlAdB04t89/1O/w1cDnyilFU=";
$channel_secret = "abb062aa3d122e3a96f680f7b434352f";
        ...
        foreach ($data['events'] as $event)
        {
            ...
            if ($event['type'] == 'message')
            {
                if($event['message']['type'] == 'text')
                {
                    ...
                    } elseif (strtolower($event['message']['text']) == 'jawa') {

                        $flexTemplate = file_get_contents("../pjawa.json"); // template flex message
